...
<body class="<?php print $classes; ?>" <?php print $attributes;?>>
  ...
  if ($uri == '/undergraduate') {

        print '<!-- Begin: www.iperceptions.com -->
		<script src="http://ips-invite.iperceptions.com/webValidator.aspx?sdfc=e1c38d43-109954-05453521-9bfe-43bb-97f7-4caade3c1502&lID=1&loc=STUDY&cD=90&rF=False&iType=1&domainname=0" type="text/javascript" defer="defer" ></script>
